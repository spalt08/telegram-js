...
export class VirtualizedList {
  ...
  virtualize(direction?: number) {
    ...
    if (this.cfg.onReachTop && this.first <= this.cfg.batch * 2) this.cfg.onReachTop();
    if (this.cfg.onReachBottom && this.current.length - this.last - 1 <= this.cfg.batch * 2) this.cfg.onReachBottom();
