...
const jpegHeader = new Uint8Array([
  ...
  ,
  ...
  0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xff, 0xda, 0x00, 0x0c, 0x03, 0x01, 0x00, 0x02, 0x11, 0x03, 0x11, 0x00, 0x3f, 0x00,
]);

const thumbMap = new Map<string, ArrayBuffer>();

export function fetchThumb(url: string, bytes: ArrayBuffer) {
  if (thumbMap.get(url)) return;

  if (url.indexOf('cached') === 1) {
    thumbMap.set(url, bytes);
  } else {
    let i = 0;
    const view = new Uint8Array(bytes);
    const buf = new Uint8Array(jpegHeader.length + bytes.byteLength - 1);

    for (; i < jpegHeader.length; i++) buf[i] = jpegHeader[i];
    for (let j = 3; j < view.length; j++) buf[i++] = view[j];
